sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("encollab/dp/vehicle/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("encollab.dp.vehicle.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["encollab/dp/vehicle/localService/mockserver"], function (mockserver) {
