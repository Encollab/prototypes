sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("encollab/dp/masterdetail/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("encollab.dp.masterdetail.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["encollab/dp/masterdetail/localService/mockserver"], function (mockserver) {
