sap.ui.define([
		...
		return BaseObject.extend("encollab.dp.masterdetail.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias encollab.dp.masterdetail.model.ListSelector
			 */
			 ...
			 * @return {encollab.dp.masterdetail.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
